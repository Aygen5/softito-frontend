...
const Object = () => {
  ...
  const adGuncelle = (yeniAd) => {
    setKullanici((prev) => ({ ...prev, ad: yeniAd,} ) );
  };


  const soyadGuncelle = (yeniSoyad) => {
    setKullanici((prev) => ({...prev,soyad: yeniSoyad,} ) );
  };



  const epostaGuncelle = (yeniEposta) => {
    setKullanici((prev) => ({...prev,eposta: yeniEposta,} ) );
  };



  const yasGuncelle = (yeniYas) => {
    setKullanici((prev) => ({ ...prev,yas: Number(yeniYas) || 0,} )) ;
  };
      ...
      <div className="demo-card-layout-grid max-w-3xl">
        ...
        <div className="demo-card demo-card-3xl demo-profile-card">
          <div>
            ...
            <div className="demo-code-footer"> <strong>Mevcut State Nesnesi (JSON)</strong>
